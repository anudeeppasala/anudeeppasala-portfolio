...
import {
  FaGithub, FaLinkedinIn, FaMedium, FaGlobe, FaInstagram, FaYoutube, FaEnvelope, FaPhone,
} from 'react-icons/fa'
...
const HERO_SOCIAL_LABELS = ['GitHub', 'LinkedIn', 'Medium']
...
export default function PublicationsFooterSection() {
  ...
  useEffect(() => {
    ...
    // Template footer-video.mp4 is Vaibhav's avatar — disabled; static Anudeep images only.
    const useFooterVideo = false

    if (!isMobile && canvas && videoEl && useFooterVideo) {
    ...
    function onScroll() {
      ...
      if (isMobile) {
        ...
        // ── Phase 3: optional crossfade image → video (disabled for Anudeep static footer) ──
        if (vidUni && videoEl) {
      ...
      <div ref={stickyRef} className={styles.sticky}>
        ...
        <div ref={pubContentRef} className={styles.pubContent}>
          ...
          <div className={styles.list}>
            {PUBS.map((pub, i) => {
              const external = /^https?:\/\//i.test(pub.link)
              return (
              <a
                key={pub.id}
                href={pub.link}
        ...
        <div ref={footerContentRef} className={styles.footerContent}>
          ...
          <div className={styles.mobileLayout}>
            ...
            <div className={styles.mobileCtas}>
              ...
              {profile.phone && (
                <a href={`tel:${profile.phone.tel}`} className={styles.mobileContactLink}>
                  <FaPhone size={12} />
            ...
            <div ref={leftRef} className={styles.leftCol}>
              ...
              <div className={styles.footerInfo}>
                ...
                <div className={styles.footerContact}>
                  ...
                  {profile.phone && (
                    <a href={`tel:${profile.phone.tel}`} className={styles.footerMail}>
                      <FaPhone size={12} />
                      {profile.phone.display}
                    </a>
                  )}
